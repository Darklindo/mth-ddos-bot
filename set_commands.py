...
commands = [
    ...
    {"command": "feedback", "description": "Enviar feedback/sugestões"},
    ...
    {"command": "stats", "description": "Estatísticas (donos)"},
    {"command": "ban", "description": "Banir usuário (donos)"},
    {"command": "unban", "description": "Desbanir (donos)"},
    {"command": "stop", "description": "Parar scan ativo (donos)"},
